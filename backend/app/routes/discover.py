...
# "Daily cron scope" section of AGENTS.md (guarded by selfcheck L5).
DEFAULT_CRON_COMPANIES = ["Anthropic", "OpenAI", "Amazon", "Google DeepMind", "Google", "Databricks", "NVIDIA", "Snowflake", "CoreWeave", "Meta"]
